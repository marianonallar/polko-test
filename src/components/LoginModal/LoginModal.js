    ...
    >
      <div className="login-modal__card" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="login-modal__subtitle">
          La plataforma que te permite gestionar seguros de manera sencilla.
        </p>

        <div className="login-modal__actions">
          <button className="login-modal__btn" type="button">
            <svg className="login-modal__btn-icon" viewBox="0 0 24 24" aria-hidden="true">
